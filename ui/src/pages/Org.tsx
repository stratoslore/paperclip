...
export function Org() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("breadcrumb", { defaultValue: "Org Chart" }) }]);
  }, [setBreadcrumbs]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={GitBranch} message={t("selectCompany", { defaultValue: "Select a company to view org chart." })} />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {data && data.length === 0 && (
        <EmptyState
          icon={GitBranch}
          message={t("empty", { defaultValue: "No agents in the organization. Create agents to build your org chart." })}
        />
      )}
