...
export function Companies() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("breadcrumb", { defaultValue: "Companies" }) }]);
  }, [setBreadcrumbs]);
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-end">
        <Button size="sm" onClick={() => openOnboarding()}>
          ...
          {t("newCompany", { defaultValue: "New Company" })}
        </Button>
      </div>

      <div className="h-6">
        {loading && <p className="text-sm text-muted-foreground">{t("loading", { defaultValue: "Loading companies..." })}</p>}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      ...
                      >
                        ...
                        {t("deleteCompany", { defaultValue: "Delete Company" })}
                      </DropdownMenuItem>
                    </DropdownMenuContent>
                  </DropdownMenu>
                </div>
                ...
                <div className="flex items-center gap-1.5 tabular-nums">
                  ...
                  <span>
                    ...
                    {company.budgetMonthlyCents > 0
                      ...
                      : <span className="text-xs ml-1">{t("unlimitedBudget", { defaultValue: "Unlimited budget" })}</span>}
                  </span>
                </div>
              ...
              {isConfirmingDelete && (
                ...
                >
                  <p className="text-sm text-destructive font-medium">
                    {t("deleteConfirmation", { defaultValue: "Delete this company and all its data? This cannot be undone." })}
                  </p>
                  <div className="flex items-center gap-2 ml-4 shrink-0">
                    ...
                    <Button
                      ...
                      disabled={deleteMutation.isPending}
                    >
                      {deleteMutation.isPending ? t("deleting", { defaultValue: "Deleting…" }) : t("delete", { defaultValue: "Delete" })}
                    </Button>
                  </div>
                </div>
              )}
