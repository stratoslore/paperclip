...
export function Issues() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("breadcrumb", { defaultValue: "Issues" }) }]);
  }, [setBreadcrumbs]);
  ...
  if (!selectedCompanyId) {
    return <EmptyState icon={CircleDot} message={t("empty.select_company", { defaultValue: "Select a company to view issues." })} />;
  }
