...
export function NewAgentDialog() {
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      title: t("newAgent.createNewAgentIssueTitle", { defaultValue: "Create a new agent" }),
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">{t("newAgent.heading", { defaultValue: "Add a new agent" })}</span>
          <Button
            variant="ghost"
            size="icon-xs"
          ...
          {!showAdvancedCards ? (
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  {t("newAgent.recommendation", { defaultValue: "We recommend letting your CEO handle agent setup — they know the org structure and can configure reporting, permissions, and adapters." })}
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                >
                  {t("newAgent.advancedConfig", { defaultValue: "I want advanced configuration myself" })}
                </button>
              </div>
            </>
          ) : (
            <>
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  {t("newAgent.chooseAdapter", { defaultValue: "Choose your adapter type for advanced setup." })}
                </p>
              </div>
